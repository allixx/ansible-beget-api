...
NB: the role does not handle domain(s) creation: they must already be present in Beget system!
      ...
      - domain: domain.com
        records:
          ...
          - type: AAAA
            subdomain: @
            value:
              - ::1                    # list is accepted as well (where applicable by Beget/DNS)
              - ::2
          - type: CAA
            subdomain: @
          ...
          - type: MX
            subdomain: @
            value: 10 mail.domain.com.    # trailing dot required
          - type: A
            subdomain: mail
            value: 1.2.3.4
          - type: CNAME
